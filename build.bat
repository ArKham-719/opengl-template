...
set CXX=g++
set CXXFLAGS=-Wall -std=c++17 -Iincludes

:: 2. Define Directories and Target
set LIB_DIR=-Llib
set LIBS=-lglfw3 -lopengl32 -lgdi32 -luser32
set OUTPUT=main.exe
set SOURCEFILES=src/main.cpp src/glad.c src/shaderClass.cpp src/VBO.cpp src/VAO.cpp src/EBO.cpp
:: 3. Clear out old build artifacts safely
if exist %OUTPUT% del /q %OUTPUT%

echo Compiling source files...
:: 4. Run the compilation command string
%CXX% %CXXFLAGS% %SOURCEFILES% -o %OUTPUT% %LIB_DIR% %LIBS%
